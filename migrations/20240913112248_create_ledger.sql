...
CREATE TABLE transfers (
    ...
    transaction_hash BYTEA CHECK (octet_length(transaction_hash) = 32) NOT NULL,
    block_number BIGINT NOT NULL ,
    data BYTEA CHECK (octet_length(data) = 32) NOT NULL,
    "from" BYTEA CHECK (octet_length("from") = 20) NOT NULL,
    "to" BYTEA CHECK (octet_length("to") = 20) NOT NULL
);
